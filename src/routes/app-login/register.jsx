        ...
        <Grid item md={5} className="bg-popup">
          <Typography component="div">
            <form className="modalform">
              ...
              <div fontWeight={500} className="h12 my-2">
                Welcome ! Please confirm that you are visiting
              </div>
              <div className="form-group">
                <div>
                  <label className="h12 bold600" for="username1">
                    Name
                  </label>
                ...
                <div>
                  <TextField
                    ...
                    onKeyUp={(e) => onValidateUserName(e)}
                    placeholder="Name"
                  />
                </div>
              </div>
              <div className="form-group">
                ...
                {email === "" && isSave ? (
                  <span className="error-msg1">Enter the EmailId</span>
                ) : null}
                <div>
                  <TextField
                    type="text"
              ...
              <div class="form-group">
                ...
                <span className="error-msg1">
                  {errorMsg && errorMsg.mobileNo}
                </span>
                {mobileNo === "" && isSave ? (
                  <span className="error-msg1">Enter the Mobile Number</span>
                ) : null}
                <div>
                  <TextField
                    type="number"
              ...
              <div class="form-group">
                ...
                <div>
                  <TextField
                    ...
                    onKeyUp={(e) =>
                      onValidatePassword(e, passwordError, { password })
                    }
              ...
              <div class="d-flex align-items-center form-group justify-content-between">
                <label class="d-flex align-items-center m-0" for="remember-me">
                  <input
                    class="mr-2 terms-input"
                    type="checkbox"
                    name="remember-me"
                    id="remember-me"
                  />
                  <span class="checkmark"></span>
                  <span class="h10 bold accept-terms">
                    {" "}
              ...
              <div className="bold500 h12 text-center">
              ...
              <div className="h10 backgroundLine mt-3 text-center">
                <span>Or</span>
              </div>
              <div className="d-flex align-items-center justify-content-center mt-2">
                <div className="mx-2">
                  <i className="iconGoogleplus icon18"></i>
                </div>
                <div className="mx-4">
                  <i className="iconFacebook icon18"></i>
                </div>
                <div className="mx-2">
                  <i className="iconTwitter icon18"></i>
                </div>
              </div>
            </form>
          </Typography>
