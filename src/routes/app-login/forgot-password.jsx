...
const UserForgotPassword = (props) => {
    const { resetPassword, setRegiterModal, setSignIn,
    } = props;
    return (
                ...
                <Grid item md={5} className="bg-popup">
                    <Typography component="div">
                        <form className="modalform">
                            ...
                            <div className="bold500 h12">Don’t have an account? <span className="link" onClick={setRegiterModal}>Register</span><span className="link h12 float-right" onClick={setSignIn}>Sign In</span></div>
                        </form>
                    </Typography>
                </Grid>
            </Grid>
